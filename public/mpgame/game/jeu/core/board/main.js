    ...
    Board.prototype = {
        ...
        preload: function() {
            ...
            for (var phyl in Especes){
                ...
                // terrain
                this.game.load.image("hexMer", "assets/images/sprites/hexMer.png");
                this.game.load.image("hexTerre", "assets/images/sprites/hexTerre.png");
                this.game.load.image("hexagon", "assets/images/sprites/hexagon.png");
                // dessins regles
                this.game.load.image("reglesEvo", "assets/images/sprites/resize/reglesEVO.png");
                this.game.load.image("reglesManger", "assets/images/sprites/resize/reglesMANGER.png");
                // icones regles
                this.game.load.image("iconeManger", "assets/images/sprites/resize/ICONEmanger.png");
                this.game.load.image("iconeEvo", "assets/images/sprites/resize/ICONEARBREEVOLUTION.png");
                // l'ipad en-dessous
                ...
                this.game.load.image("vaisseau", "assets/images/sprites/resize/vaisseau.png");

                var path = 'assets/images/sprites/resize/';
                for (var phyl in Especes) {
